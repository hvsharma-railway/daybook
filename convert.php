...
?>
  ...
  <script type='text/javascript'>
   ...
   function lastInputChange(id){
        ...
        var totalLastVal = 0.00, totalToEnd = 0.00;
        ...
        $("#totalLastMonth").val(totalLastVal);
    ...
    $(".btn").click(function () {
        ...
        frameDoc.document.write('<style> .table-bordered tbody tr td, .table-bordered thead tr th { border: 1px solid black !important; width:450px;} </style>');
        ...
        for (const [key, value] of myMap.entries()) {
             $("#"+key).html(value);console.log(key, value);
        }
        console.log(myMap);
    });
});
