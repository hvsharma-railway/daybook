        ...
        <div class="card shadow-sm h-100">
          <div class="card-body">
            <form id="seperateJVForm" action="uploadFile.php" method="post" enctype="multipart/form-data">
              <div class="mb-3">
                <label for="jvFiles" class="form-label"><strong>Step 1:</strong> Seperate JV and Allocation (.xlsx, multiple files)</label>
        ...
        <div class="card shadow-sm h-100">
          <div class="card-body">
            <form id="suspenseHeadForm" action="uploadFile.php" method="post" enctype="multipart/form-data">
              <div class="mb-3">
                <label for="file" class="form-label"><strong>Step 2:</strong> SuspenseHead (.xlsx)</label>
              ...
              <a href="view.php" class="btn btn-link w-100">View Day Book</a>
            </form>
          </div>
        </div>
      </div>
        ...
        <div class="row justify-content-center">
          <div class="col-auto">
            <div class="text-center py-3 px-4 bg-white rounded-4 shadow-sm border border-2 border-primary-subtle">
              <span class="d-block fw-semibold text-success mb-1">Managed by</span>
              <span class="d-block small text-secondary">IT Cell, Office of Sr.DFM - RJT, WR</span>
            </div>
          </div>
        </div>
      </div>
